  ...
  return (
    <div className="flex flex-col gap-5 sm:gap-6 lg:flex-row lg:items-start lg:justify-between">
      <div className="flex items-start gap-4">
        <div className="mt-1 flex h-12 w-12 items-center justify-center rounded-full bg-[linear-gradient(135deg,#f7f0ff_0%,#ede7ff_100%)] shadow-[0_8px_24px_rgba(141,102,255,0.12)]">
          <Sparkles className="h-5 w-5 text-[#7b52f3]" />
        </div>
        <div>
          <h1 className="text-[clamp(2.1rem,7vw,3.25rem)] font-semibold tracking-[-0.055em] text-[#12102a]">
